...
<template>
	<div class="max-w-2xl m-auto">
		...
		<div id="tabpanel-1" role="tabpanel" tabindex="0" aria-labelledby="tab-1" :class="{ 'is-hidden': selectedTab !== 1 }">
			<textarea aria-label="The text the user inputs." :spellcheck="!settings.disableSpellCheck" v-model="inputText"></textarea>
		</div>
		<div id="tabpanel-2" role="tabpanel" tabindex="0" aria-labelledby="tab-2" :class="{ 'is-hidden': selectedTab !== 2 }">
			<textarea
				aria-label="The text the program outputs."
